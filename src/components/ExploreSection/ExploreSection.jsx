...
{/*             <div className="lg:col-span-3 md:col-span-4  bg-gray-100/90 lg:p-4  p-3 rounded-md">
            ...
            <div className="lg:col-span-8 md:col-span-4 bg-gray-100/90 lg:p-4  p-3 rounded-md">
              <MostFavouriteMenuItems />
            </div>
            <div className="lg:col-span-4 md:col-span-4  bg-gray-100/90 lg:p-4  p-3 rounded-md">
              <DiscountedMenus />
            </div>
          </div>
        </div>
