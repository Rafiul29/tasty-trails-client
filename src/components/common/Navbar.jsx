      ...
      <div className="wrapper  flex flex-wrap items-center justify-between mx-auto py-4 ">
        ...
        >
         ...
         {isLoggedIn && (
             ...
             <Link
               to="/carts"
               className="relative block py-2 px-3 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"
             >
               <svg
               ...
               <span className="flex justify-center items-center bg-orange-500 text-white h-6 w-6 rounded-full  absolute -top-1 left-6 md:-top-4 md:left-2">{cartItems?.length==0? 0:cartItems?.length}</span>
             </Link>
           </li>
         )}
            {!isLoggedIn && (
